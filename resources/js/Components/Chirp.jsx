				...
				<div className="flex justify-between items-center">
					...
					{chirp.user.id === auth.user.id && (
						<Dropdown>
							...
							<Dropdown.Content>
								<button
									className="block w-full px-4 py-2 text-left text-sm leading-5 dark:text-gray-400 dark:hover:text-gray-300 dark:focus:text-gray-300 transition duration-150 ease-in-out"
